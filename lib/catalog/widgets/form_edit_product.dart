...
class FormEditProduct extends StatefulWidget {
  const FormEditProduct({super.key, required this.product});
...
class _FormEditProductState extends State<FormEditProduct> {
  final formEditProductKey = GlobalKey<FormState>();
              ...
              BlocBuilder<CategoryBloc, CategoryState>(
                builder: (context, state) {
                  ...
                  return DropdownButtonFormField<String>(
                    ...
                    value: categoryExists ? category : null,
                    onChanged: (value) {
                      setState(() {
                        category = value;
                      });
  ...
  void dispose() {
    ...
    formEditProductKey.currentState?.dispose();
